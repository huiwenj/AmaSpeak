...
// node_modules/.pnpm/@lottiefiles+dotlottie-react@0.8.12_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/@lottiefiles/dotlottie-react/dist/index.js
...
var Y3 = (() => {
  var _a;
  var f = typeof document < "u" ? (_a = document.currentScript) == null ? void 0 : _a.src : void 0;
  return function(n = {}) {
    ...
    function w1(e) {
      var _a2;
      throw (_a2 = r.onAbort) == null ? void 0 : _a2.call(r, e), e = "Aborted(" + e + ")", n1(e), c2 = true, e = new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info."), y(e), e;
    }
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var k3 = { c: (e, t, i, a) => {
      ...
      function e(i) {
        var _a3;
        return P = i.exports, y1 = P.da, v2(), O = P.ha, m2.unshift(P.ea), K--, (_a3 = r.monitorRunDependencies) == null ? void 0 : _a3.call(r, K), K == 0 && (u1 && (i = u1, u1 = null, i())), P;
      }
      var t = { a: k3 };
      if (K++, (_a2 = r.monitorRunDependencies) == null ? void 0 : _a2.call(r, K), r.instantiateWasm)
        try {
...
var o1 = class {
  ...
  dispatch(n) {
    var _a;
    (_a = this._eventListeners.get(n.type)) == null ? void 0 : _a.forEach((c) => c(n));
  }
...
var A = class {
  ...
  static observe(n, r) {
    var _a;
    this._initializeObserver(), !this._observedCanvases.has(n) && (this._observedCanvases.set(n, r), (_a = this._observer) == null ? void 0 : _a.observe(n));
  }
  static unobserve(n) {
    var _a, _b;
    (_a = this._observer) == null ? void 0 : _a.unobserve(n), this._observedCanvases.delete(n), this._observedCanvases.size === 0 && ((_b = this._observer) == null ? void 0 : _b.disconnect(), this._observer = null);
  }
};
...
var k = class {
  ...
  static observe(n, r) {
    var _a;
    this._initializeObserver(), !this._observedCanvases.has(n) && (this._observedCanvases.set(n, [r, 0]), (_a = this._observer) == null ? void 0 : _a.observe(n));
  }
  static unobserve(n) {
    var _a, _b;
    (_a = this._observer) == null ? void 0 : _a.unobserve(n), this._observedCanvases.delete(n), this._observedCanvases.size === 0 && ((_b = this._observer) == null ? void 0 : _b.disconnect(), this._observer = null);
...
var C = class C2 {
  constructor(n) {
    ...
    this._canvas = n.canvas, this._context = this._canvas.getContext("2d"), this._eventManager = new o1(), this._frameManager = new x1(), this._renderConfig = { ...n.renderConfig, devicePixelRatio: ((_a = n.renderConfig) == null ? void 0 : _a.devicePixelRatio) || e1(), freezeOnOffscreen: ((_b = n.renderConfig) == null ? void 0 : _b.freezeOnOffscreen) ?? true }, Q.load().then((r) => {
  ...
  get layout() {
    ...
    if (n)
      return { align: [n.align.get(0), n.align.get(1)], fit: (() => {
        ...
        switch (n.fit) {
          case ((_a2 = C2._wasmModule) == null ? void 0 : _a2.Fit.Contain):
            return "contain";
          case ((_b = C2._wasmModule) == null ? void 0 : _b.Fit.Cover):
            return "cover";
          case ((_c = C2._wasmModule) == null ? void 0 : _c.Fit.Fill):
            return "fill";
          case ((_d = C2._wasmModule) == null ? void 0 : _d.Fit.FitHeight):
            return "fit-height";
          case ((_e = C2._wasmModule) == null ? void 0 : _e.Fit.FitWidth):
            return "fit-width";
          case ((_f = C2._wasmModule) == null ? void 0 : _f.Fit.None):
            return "none";
          default:
            return "contain";
        }
  ...
  get mode() {
    ...
    return n === ((_b = C2._wasmModule) == null ? void 0 : _b.Mode.Reverse) ? "reverse" : n === ((_c = C2._wasmModule) == null ? void 0 : _c.Mode.Bounce) ? "bounce" : n === ((_d = C2._wasmModule) == null ? void 0 : _d.Mode.ReverseBounce) ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  destroy() {
    var _a;
    I && this._canvas instanceof HTMLCanvasElement && (A.unobserve(this._canvas), k.unobserve(this._canvas)), (_a = this._dotLottieCore) == null ? void 0 : _a.delete(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: "destroy" }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  postStateMachineEvent(n) {
    var _a;
    let r = ((_a = this._dotLottieCore) == null ? void 0 : _a.postEventPayload(n)) ?? 1;
  ...
  animationSize() {
    var _a, _b;
    let n = ((_a = this._dotLottieCore) == null ? void 0 : _a.animationSize().get(0)) ?? 0, r = ((_b = this._dotLottieCore) == null ? void 0 : _b.animationSize().get(1)) ?? 0;
    return { width: n, height: r };
  }
  setStateMachineBooleanContext(n, r) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.setStateMachineBooleanContext(n, r)) ?? false;
  }
  setStateMachineNumericContext(n, r) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.setStateMachineNumericContext(n, r)) ?? false;
  }
  setStateMachineStringContext(n, r) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.setStateMachineStringContext(n, r)) ?? false;
  }
};
...
var N = class N2 {
  constructor(n) {
    ...
    this._worker = N2._workerManager.getWorker(r), N2._workerManager.assignAnimationToWorker(this._id, r), N2._wasmUrl && this._sendMessage("setWasmUrl", { url: N2._wasmUrl }), this._create({ ...n, renderConfig: { ...n.renderConfig, devicePixelRatio: ((_a = n.renderConfig) == null ? void 0 : _a.devicePixelRatio) || e1(), freezeOnOffscreen: ((_b = n.renderConfig) == null ? void 0 : _b.freezeOnOffscreen) ?? true } }), this._worker.addEventListener("message", this._handleWorkerEvent.bind(this)), this._pointerUpMethod = this._onPointerUp.bind(this), this._pointerDownMethod = this._onPointerDown.bind(this), this._pointerMoveMethod = this._onPointerMove.bind(this), this._pointerEnterMethod = this._onPointerEnter.bind(this), this._pointerExitMethod = this._onPointerLeave.bind(this), this._onCompleteMethod = this._onComplete.bind(this);
  }
